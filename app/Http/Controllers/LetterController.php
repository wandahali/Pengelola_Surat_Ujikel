...
class LetterController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('letter.create', compact('types', 'gurus'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('letter.edit', compact('letter', 'types', 'gurus'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('letter.index')->with('deleted', 'Berhasil Menghapus Data');
    }

    public function export()
    {
        $fill = 'surat.xlsx';
        return Excel::download(new LetterExport, $fill);
    }
